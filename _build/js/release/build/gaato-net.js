...
function _M0FP28internal11gaato_2dnet4i18n(lang) {
  switch (lang) {
    case 0: {
      return new _M0TP28internal11gaato_2dnet4I18n("gaato.net", "がーと / gaato", ["技術と語学とVTuberが好きです。"], "Links", ["コードと実験", "近況", "記事", "技術メモ", "仕事寄りのプロフィール", "openSUSE packaging"]);
    }
    case 1: {
      return new _M0TP28internal11gaato_2dnet4I18n("gaato.net", "がーと / gaato", ["I like technology, languages, and VTubers."], "Links", ["Code and experiments", "Short updates", "Articles", "Technical notes", "Work-oriented profile", "openSUSE packaging"]);
    }
    default: {
      return new _M0TP28internal11gaato_2dnet4I18n("gaato.net", "がーと / gaato", ["Saya suka teknologi, bahasa, dan VTuber."], "Tautan", ["Kode dan eksperimen", "Kabar singkat", "Artikel", "Catatan teknis", "Profil untuk pekerjaan", "Packaging openSUSE"]);
    }
  }
}
