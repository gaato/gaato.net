...
const _M0FP28internal11gaato_2dnet5linksN6recordS195 = new _M0TP28internal11gaato_2dnet11ProfileLink("Mathlog", "https://mathlog.info/users/368");
const _M0FP28internal11gaato_2dnet5linksN6recordS196 = new _M0TP28internal11gaato_2dnet11ProfileLink("LinkedIn", "https://www.linkedin.com/in/gaato");
const _M0FP28internal11gaato_2dnet5linksN6recordS197 = new _M0TP28internal11gaato_2dnet11ProfileLink("openSUSE Build Service", "https://build.opensuse.org/users/gaato");
const _M0FP28internal11gaato_2dnet10link__cardN6constrS198 = "_blank";
const _M0FP28internal11gaato_2dnet10link__cardN6constrS199 = "link-card";
const _M0FP28internal11gaato_2dnet10link__cardN6constrS200 = new _M0DTP56mizchi4luna8platform3dom7element4Attr10AttrString("noopener noreferrer");
const _M0FP28internal11gaato_2dnet10link__cardN5tupleS201 = { _0: "rel", _1: _M0FP28internal11gaato_2dnet10link__cardN6constrS200 };
const _M0FP28internal11gaato_2dnet10link__cardN6constrS202 = "link-label-row";
const _M0FP28internal11gaato_2dnet10link__cardN6constrS203 = "link-label";
const _M0FP28internal11gaato_2dnet10link__cardN6constrS204 = "link-arrow";
const _M0FP28internal11gaato_2dnet10link__cardN6constrS205 = "link-note";
...
const _M0FP28internal11gaato_2dnet7_2amainN6constrS206 = "page";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS207 = "topbar";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS208 = "eyebrow-block";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS209 = "eyebrow";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS210 = "lang-switcher";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS211 = "panel hero";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS212 = "handle";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS213 = "summary";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS214 = "panel";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS215 = "section-title";
const _M0FP28internal11gaato_2dnet7_2amainN6constrS216 = "links";
...
function _M0MP46mizchi2js3web5event11EventTarget24addEventListener_2einner(self, event_type, handler, capture, once, passive, signal) {
  ...
  if (signal.$tag === 1) {
    const _Some = signal;
    const _v = _Some._0;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(entries, { _0: "signal", _1: _v });
  }
...
function _M0FP46mizchi4luna4luna6signal18register__disposer(disposer) {
  ...
  if (_bind === undefined) {
    ...
    const _Some = _bind;
    const _owner = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(_owner.disposers, disposer);
    return;
  }
}
...
function _M0FP46mizchi4luna4luna6signal6effect(fn_) {
  ...
  const run_effect = () => {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _runner = _Some;
      _M0FP46mizchi4luna4luna6signal21run__with__subscriberGuE(_runner, () => {
...
function _M0MP46mizchi4luna4luna6signal6Signal3getGRP28internal11gaato_2dnet4LangE(self) {
  const _bind = _M0FP46mizchi4luna4luna6signal17reactive__context.current_subscriber;
  if (_bind === undefined) {
  } else {
    const _Some = _bind;
    const _subscriber = _Some;
    const _p = _M0MPC15array5Array4iterGRP46mizchi4luna4luna6signal12EffectRunnerE(self.subscribers);
    let already_subscribed;
    while (true) {
      const _p$2 = _M0MPB4Iter4nextGRP46mizchi4luna4luna6signal12EffectRunnerE(_p);
      if (_p$2 === undefined) {
    ...
    if (!already_subscribed) {
      _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(self.subscribers, _subscriber);
    }
  }
  return self.value;
}
...
function _M0FP56mizchi4luna8platform3dom7element16apply__attribute(elem, name, value) {
  switch (value.$tag) {
    case 0: {
      ...
      const _s = _Static._0;
      if (name === "style") {
        _M0FP56mizchi4luna8platform3dom7element20apply__style__string(elem, _s);
        return;
      } else {
        _M0FP56mizchi4luna8platform3dom7element19apply__static__attr(elem, name, _s);
        return;
      }
    }
    case 1: {
    ...
    default: {
      ...
      if (name === "__ref") {
        ...
        _M0FP56mizchi4luna8platform3dom7element21apply__event__handler(elem, name, _handler);
        return;
      }
    }
  }
...
function _M0FP56mizchi4luna8platform3dom7element15create__element(tag, attrs, children) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0FP56mizchi4luna8platform3dom7element16apply__attribute(elem, _name, _value);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP56mizchi4luna8platform3dom7element5mount(container, n) {
  _M0MP46mizchi2js7browser3dom4Node11appendChild(container.inner, _M0MP56mizchi4luna8platform3dom7element7DomNode9to__jsdom(n));
}
function _M0FP56mizchi4luna8platform3dom7element5clear(container) {
  _M0MP46mizchi2js7browser3dom4Node14setTextContent(container.inner, "");
}
...
function _M0IP56mizchi4luna8platform3dom7element4AttrPB4Show6output(self, logger) {
  switch (self.$tag) {
    ...
    case 1: {
      ...
      logger.method_table.method_0(logger.self, _M0FP56mizchi4luna8platform3dom7element18double__to__string(_d));
      return;
    }
    case 2: {
      const _AttrInt = self;
      const _i = _AttrInt._0;
      logger.method_table.method_0(logger.self, _M0MPC13int3Int18to__string_2einner(_i, 10));
      return;
    }
    default: {
      const _AttrBool = self;
      const _b = _AttrBool._0;
      logger.method_table.method_0(logger.self, _M0IP016_24default__implPB4Show10to__stringGbE(_b));
      return;
    }
  }
}
...
function _M0FP56mizchi4luna8platform3dom7element20build__props_2einner(id, class_, style, on, ref_, attrs, dyn_attrs) {
  ...
  if (id === undefined) {
    ...
    const _Some = id;
    const _v = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(result, { _0: "id", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue6Static(_v) });
  }
  if (class_ === undefined) {
  } else {
    const _Some = class_;
    const _v = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(result, { _0: "className", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue6Static(_v) });
  }
  if (style === undefined) {
  } else {
    const _Some = style;
    const _s = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(result, { _0: "style", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue6Static(_s) });
  }
  if (on.$tag === 1) {
    const _Some = on;
    const _handlers = _Some._0;
    const _bind = _M0MP56mizchi4luna8platform3dom7element10HandlerMap9to__attrs(_handlers);
    const _bind$2 = _bind.length;
    let _tmp = 0;
    while (true) {
      const _ = _tmp;
...
function _M0FP56mizchi4luna8platform3dom7element3div(id, class_, style, dyn_class, dyn_style, on, ref_, attrs, dyn_attrs, children) {
  ...
  if (dyn_class === undefined) {
    ...
    const _getter = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, { _0: "className", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue7Dynamic(_getter) });
  }
  if (dyn_style === undefined) {
  } else {
    const _Some = dyn_style;
    const _getter = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, { _0: "style", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue7Dynamic(_getter) });
  }
...
function _M0FP56mizchi4luna8platform3dom7element1a(href, target, id, class_, style, dyn_class, dyn_style, on, ref_, attrs, dyn_attrs, children) {
  ...
  if (href === undefined) {
    ...
    const _Some = href;
    const _v = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, { _0: "href", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue6Static(_v) });
  }
  if (target === undefined) {
  } else {
    const _Some = target;
    const _v = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, { _0: "target", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue6Static(_v) });
  }
  if (dyn_class === undefined) {
  } else {
    const _Some = dyn_class;
...
function _M0FP56mizchi4luna8platform3dom7element6button(disabled, id, class_, style, dyn_class, dyn_style, dyn_disabled, on, ref_, attrs, dyn_attrs, children) {
  ...
  if (disabled === -1) {
    ...
    const _x = _Some;
    if (_x === true) {
      _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, _M0FP56mizchi4luna8platform3dom7element6buttonN5tupleS1340);
    }
  }
  if (dyn_class === undefined) {
  } else {
  ...
  if (dyn_disabled === undefined) {
    ...
    const _getter = _Some;
    _M0MPC15array5Array4pushGUsRP56mizchi4luna8platform3dom7element9AttrValueEE(props, { _0: "disabled", _1: new _M0DTP56mizchi4luna8platform3dom7element9AttrValue7Dynamic(() => _M0IP016_24default__implPB4Show10to__stringGbE(_getter())) });
  }
...
function _M0FP28internal11gaato_2dnet16automaton__rules() {
  return [new _M0TP28internal11gaato_2dnet13AutomatonRule([3], [2, 3]), new _M0TP28internal11gaato_2dnet13AutomatonRule([3, 6], [2, 3]), new _M0TP28internal11gaato_2dnet13AutomatonRule([3], [1, 2, 3, 4, 5]), new _M0TP28internal11gaato_2dnet13AutomatonRule([3, 6, 7, 8], [3, 4, 6, 7, 8]), new _M0TP28internal11gaato_2dnet13AutomatonRule([4, 6, 7, 8], [3, 5, 6, 7, 8])];
}
...
function _M0FP28internal11gaato_2dnet23random__automaton__rule() {
  const rules = _M0FP28internal11gaato_2dnet16automaton__rules();
  return _M0MPC15array5Array2atGsE(rules, _M0FP28internal11gaato_2dnet13random__index(rules.length));
}
...
function _M0FP28internal11gaato_2dnet26ensure__background__canvas(doc) {
  ...
  if (_bind.$tag === 1) {
    ...
    if (_bind$2.$tag === 1) {
      ...
      _M0MP46mizchi2js7browser3dom7Element7prepend(_body, [canvas]);
    }
    return canvas;
  }
}
          ...
          while (true) {
            ...
            if (column_offset <= 1) {
              ...
              if (_M0MP46mizchi2js8builtins4math4Math6random() > 0.45) {
                ...
                const _tmp$4 = state.energy;
                const _p = _M0MPC15array5Array2atGdE(state.energy, cell_index);
                const _p$2 = 0.45;
                _M0MPC15array5Array3setGdE(_tmp$4, cell_index, _p > _p$2 ? _p : _p$2);
              }
      ...
      while (true) {
        ...
        if (column_offset <= 1) {
          if (row_offset !== 0 || column_offset !== 0) {
            ...
            count = count + _M0MPC15array5Array2atGiE(state.current, (Math.imul(neighbor_row, state.columns) | 0) + neighbor_column | 0) | 0;
          }
...
function _M0FP28internal11gaato_2dnet16step__background(state) {
    ...
    if (row < state.rows) {
      ...
      while (true) {
        ...
        if (column < state.columns) {
          ...
          const next_alive = alive ? (_M0FP28internal11gaato_2dnet25contains__neighbor__count(state.rule.survive, neighbors) ? 1 : 0) : _M0FP28internal11gaato_2dnet25contains__neighbor__count(state.rule.birth, neighbors) ? 1 : 0;
          _M0MPC15array5Array3setGiE(state.next, index, next_alive);
          const previous_energy = _M0MPC15array5Array2atGdE(state.energy, index);
          const _tmp$3 = state.energy;
          let _tmp$4;
          if (next_alive === 1) {
            const _p = 1;
            const _p$2 = previous_energy + 0.18;
            _tmp$4 = _p < _p$2 ? _p : _p$2;
          } else {
            const _p = 0;
            const _p$2 = previous_energy - 0.055;
            _tmp$4 = _p > _p$2 ? _p : _p$2;
          }
          _M0MPC15array5Array3setGdE(_tmp$3, index, _tmp$4);
          alive_count = alive_count + next_alive | 0;
          _tmp$2 = column + 1 | 0;
          continue;
        } else {
          break;
  ...
  if (alive_count < _M0MP46mizchi2js8builtins4math4Math5round(((Math.imul(state.columns, state.rows) | 0) + 0) * 0.08) || (state.generation % 18 | 0) === 0) {
...
function _M0FP28internal11gaato_2dnet18resize__background(state) {
  ...
  const _p = _M0MP46mizchi2js7browser3dom6Window16devicePixelRatio(state.win);
  const _p$2 = 2;
  state.dpr = _p < _p$2 ? _p : _p$2;
  state.reduced_motion = _M0FP28internal11gaato_2dnet24prefers__reduced__motion(state.win);
  const _p$3 = _M0MP46mizchi2js8builtins4math4Math5round((state.width + 0) / (72 + 0));
  const _p$4 = 10;
  const _p$5 = 18;
  state.cell_size = _p$3 < _p$4 ? _p$4 : _p$3 > _p$5 ? _p$5 : _p$3;
  const _p$6 = state.width;
  const _p$7 = state.cell_size;
  state.columns = ((_p$6 + _p$7 | 0) - 1 | 0) / _p$7 | 0;
  const _p$8 = state.height;
  const _p$9 = state.cell_size;
  state.rows = ((_p$8 + _p$9 | 0) - 1 | 0) / _p$9 | 0;
...
function _M0FP28internal11gaato_2dnet27schedule__background__frame(state) {
  _M0MP46mizchi2js7browser3dom6Window21requestAnimationFrame(state.win, (time) => {
    ...
    let delta = time - state.last_time;
    if (delta > 1000) {
      delta = 1000;
    }
    state.last_time = time;
...
function _M0FP28internal11gaato_2dnet10link__card(index, current) {
  const link = _M0MPC15array5Array2atGsE([_M0FP28internal11gaato_2dnet5linksN6recordS191, _M0FP28internal11gaato_2dnet5linksN6recordS192, _M0FP28internal11gaato_2dnet5linksN6recordS193, _M0FP28internal11gaato_2dnet5linksN6recordS194, _M0FP28internal11gaato_2dnet5linksN6recordS195, _M0FP28internal11gaato_2dnet5linksN6recordS196, _M0FP28internal11gaato_2dnet5linksN6recordS197], index);
  return _M0FP56mizchi4luna8platform3dom7element2li(undefined, undefined, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element1a(link.url, _M0FP28internal11gaato_2dnet10link__cardN6constrS198, undefined, _M0FP28internal11gaato_2dnet10link__cardN6constrS199, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, new _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4Some([_M0FP28internal11gaato_2dnet10link__cardN5tupleS201]), _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet10link__cardN6constrS202, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element1p(undefined, _M0FP28internal11gaato_2dnet10link__cardN6constrS203, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element4text(link.label)]), _M0FP56mizchi4luna8platform3dom7element1p(undefined, _M0FP28internal11gaato_2dnet10link__cardN6constrS204, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element4text("↗")])]), _M0FP56mizchi4luna8platform3dom7element1p(undefined, _M0FP28internal11gaato_2dnet10link__cardN6constrS205, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element9text__dyn(() => _M0MPC15array5Array2atGsE(_M0FP28internal11gaato_2dnet4i18n(_M0MP46mizchi4luna4luna6signal6Signal3getGRP28internal11gaato_2dnet4LangE(current)).link_notes, index))])])]);
}
(() => {
  ...
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _el = _Some._0;
    const app = _M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS206, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS207, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS208, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element1p(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS209, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element9text__dyn(() => _M0FP28internal11gaato_2dnet4i18n(_M0MP46mizchi4luna4luna6signal6Signal3getGRP28internal11gaato_2dnet4LangE(current_lang)).eyebrow)])]), _M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS210, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP28internal11gaato_2dnet12lang__button(0, current_lang), _M0FP28internal11gaato_2dnet12lang__button(1, current_lang), _M0FP28internal11gaato_2dnet12lang__button(2, current_lang)])]), _M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS211, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element2h1(undefined, undefined, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element9text__dyn(() => _M0FP28internal11gaato_2dnet4i18n(_M0MP46mizchi4luna4luna6signal6Signal3getGRP28internal11gaato_2dnet4LangE(current_lang)).headline)]), _M0FP56mizchi4luna8platform3dom7element1p(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS212, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element4text("gaato.net")]), _M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS213, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP28internal11gaato_2dnet13summary__line(0, current_lang)])]), _M0FP56mizchi4luna8platform3dom7element3div(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS214, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element2h2(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS215, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP56mizchi4luna8platform3dom7element9text__dyn(() => _M0FP28internal11gaato_2dnet4i18n(_M0MP46mizchi4luna4luna6signal6Signal3getGRP28internal11gaato_2dnet4LangE(current_lang)).links_title)]), _M0FP56mizchi4luna8platform3dom7element2ul(undefined, _M0FP28internal11gaato_2dnet7_2amainN6constrS216, undefined, undefined, undefined, _M0DTPC16option6OptionGRP56mizchi4luna8platform3dom7element10HandlerMapE4None__, undefined, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element4AttrEEE4None__, _M0DTPC16option6OptionGRPB5ArrayGUsRP56mizchi4luna8platform3dom7element9AttrValueEEE4None__, [_M0FP28internal11gaato_2dnet10link__card(0, current_lang), _M0FP28internal11gaato_2dnet10link__card(1, current_lang), _M0FP28internal11gaato_2dnet10link__card(2, current_lang), _M0FP28internal11gaato_2dnet10link__card(3, current_lang), _M0FP28internal11gaato_2dnet10link__card(4, current_lang), _M0FP28internal11gaato_2dnet10link__card(5, current_lang), _M0FP28internal11gaato_2dnet10link__card(6, current_lang)])])]);
